...
class Pilha { // Lista para o tipo Jogador
    // Atributos
    private Jogador[] array;
    private int n;
    ...
    public Jogador pop() {
        Jogador removido = array[--n];
        return removido;
    }

    public Pilha listaToPilha(Lista jogadores) {
        Pilha p = new Pilha();
        for(int i = 0; i < jogadores.size(); i++) {
            p.push(jogadores.get(i));
        }
        return p;
    }
...
class Jogador {
    ...
    public static Resultado callCommand(String[] comando_numero, Pilha jogadores, Lista todos_jogadores) throws Exception {
    ...
    public static void imprimir_verde(Pilha jogadores) {
        for (int i = 0; i < jogadores.size(); i++) {
...
public class Questao3 extends Jogador {
    ...
    public static void main(String[] args) throws Exception {
        ...
        pilhaJogadores = pilhaJogadores.listaToPilha(Jogadores);

        for (int i = 1; i <= n; i++) {
            // System.out.println(comandos[i]);
            String[] comandos_aux = trataString(comandos[i]);
            Resultado resultado = callCommand(comandos_aux,pilhaJogadores, todos_Jogadores);
            pilhaJogadores = resultado.jogadoresAtualizados;
